...
#     np.sin(psi_est)*np.sin(phi_est)*(measurements[i][0]-x_k_km1[0][0])-np.sin(phi_est)*np.cos(psi_est)*(measurements[i][1]-x_k_km1[0][1])+np.cos(phi_est)*(measurements[i][2]-x_k_km1[0][2]),
#     -np.cos(phi_est)*np.cos(psi_est)*(measurements[i][0]-x_k_km1[0][0])-np.cos(phi_est)*np.sin(psi_est)*(measurements[i][1]-x_k_km1[0][1])]])
#     # H = np.array([[np.sin(phi_est),np.cos(phi_est)*np.cos(psi_est),-np.sin(phi_est)*np.cos(psi_est),
#     # np.sin(psi_est)*np.sin(phi_est)*x_k_km1[0][2]-np.sin(phi_est)*np.cos(psi_est)*x_k_km1[0][1],
#     # -np.cos(phi_est)*np.cos(psi_est)*x_k_km1[0][2]-np.cos(phi_est)*np.sin(psi_est)*x_k_km1[0][1]+np.cos(phi_est)*x_k_km1[0][0],0]])
...
#     R = sigma_r**2*(C_WT[0][1]+C_WT[1][1]+C_WT[2][1])
